...
if command -v python3 >/dev/null; then
    python3 -m pip install --quiet streamlit schemdraw matplotlib pillow \
        && echo "  py: streamlit/schemdraw/matplotlib/pillow OK" \
        || echo "  △ py 失敗。手動: pip install streamlit schemdraw matplotlib pillow"
else
